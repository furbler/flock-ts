...
var Canvas2DUtility = /** @class */ (function () {
     ...
     */
    function Canvas2DUtility(canvas) {
        /**
     ...
     */
    Canvas2DUtility.prototype.drawLine = function (x1, y1, x2, y2, color, width) {
     ...
     */
    Canvas2DUtility.prototype.drawPolygon = function (points, color) {
     ...
     */
    Canvas2DUtility.prototype.drawCircle = function (x, y, radius, color) {
        // 色が指定されている場合はスタイルを設定する
        if (color != null) {
            this.context2d.fillStyle = color;
        }
     ...
     */
    Canvas2DUtility.prototype.drawFan = function (x, y, radius, startRadian, endRadian, color) {
        // 色が指定されている場合はスタイルを設定する
        if (color != null) {
            this.context2d.fillStyle = color;
        }
     ...
     * @param {number} [width=1] - 線幅
     */
    Canvas2DUtility.prototype.drawQuadraticBezier = function (x1, y1, x2, y2, cx, cy, color, width) {
        if (width === void 0) { width = 1; }
        // 色が指定されている場合はスタイルを設定する
        if (color != null) {
            this.context2d.strokeStyle = color;
     ...
     * @param {number} [width=1] - 線幅
     */
    Canvas2DUtility.prototype.drawCubicBezier = function (x1, y1, x2, y2, cx1, cy1, cx2, cy2, color, width) {
        if (width === void 0) { width = 1; }
        // 色が指定されている場合はスタイルを設定する
        if (color != null) {
            this.context2d.strokeStyle = color;
     ...
     */
    Canvas2DUtility.prototype.drawText = function (text, x, y, color, width) {
     ...
     */
    Canvas2DUtility.prototype.imageLoader = function (path, callback) {
        // 画像のインスタンスを生成する
